...
class UserProfileAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Permissions', {'fields': ('is_superuser','is_active','host_2_user','host_group','user_permissions','groups')}),
    )
    ...
    search_fields = ('email',)
    ordering = ('email',)
    filter_horizontal = ("host_2_user","host_group","user_permissions","groups")
...
admin.site.register(models.HostToUser)
